...
namespace DigitalRuby.SoundManagerNamespace
{
    ...
    public class LoopingAudioSource
    {
        ...
        public bool Play(float targetVolume, bool isMusic)
        {
            if (AudioSource != null)
            {
                // targetVolume = targetVolume * OriginalVolume;
    ...
    public static class SoundManagerExtensions
    {
        ...
        public static void PlayLoopingMusicManaged(this AudioSource source, float volumeScale, float fadeSeconds, bool persist, bool stopAll = true)
        {
            SoundManager.PlayLoopingMusic(source, volumeScale, fadeSeconds, persist, stopAll);
        }
    ...
    public class SoundManager : MonoBehaviour
    {
        ...
        /// <param name="fadeSeconds">Seconds to fade in and out</param>
        /// <param name="persist">Whether to persist the looping music between scene changes</param>
        public static void PlayLoopingMusic(AudioSource source, float volumeScale, float fadeSeconds, bool persist, bool stopAll = true)
        {
            PlayLooping(source, music, volumeScale, fadeSeconds, persist, stopAll);
            UpdateMusic();
        }
